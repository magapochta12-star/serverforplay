...
# Хранилище комнат
rooms = {}  # room_id -> {"host": ws, "guest": ws, "seed": int, "started": bool}
    ...
    try:
        async for message in websocket:
            ...
            if action == "create":
                ...
                # Пересылаем input другому игроку
            ...
            if role == "host":
                ...
                if room["guest"]:
                    try:
                        ...
                        pass
                del rooms[room_id]
                print(f"Комната {room_id} закрыта (хост вышел)")
            elif role == "guest":
                room["guest"] = None
                room["started"] = False
                try:
                    ...
                    pass
                print(f"Гость вышел из {room_id}")
